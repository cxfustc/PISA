...
void pe_seq_assign (pe_seq_t * p, int end, const char * name, const char * anno,
    const char * bases, const char * quals);
void pe_seq_pool_dump (FILE ** out, mp_t(pe) * pes);
void pe_seq_pool_dump_lfq (FILE * out, mp_t(pe) * pes);
...
struct pefq_blk_s;
typedef struct pefq_blk_s pefq_blk_t;
...
pefq_blk_t * pefq_blk_init (int32_t max);
void pefq_blk_free (pefq_blk_t * blk);

pefq_reader_t * pefq_reader_init (const char * fq1_file, const char * fq2_file);
void pefq_reader_destroy (pefq_reader_t * reader);
int pefq_reader_load_block (pefq_reader_t * reader, pefq_blk_t * blk);

mp_t(pe) * pefq_load (const char * fq1_file, const char * fq2_file);
void pefq_load1pair (mp_t(pe) * pes, const char * fq1_file, const char * fq2_file);
